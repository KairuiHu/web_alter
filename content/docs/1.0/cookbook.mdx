...
1. **[API Keys & Authentication](/docs/1.0/synvo-api/api-keys-authentication)** - Manage your API keys
2. **[File Metadata](/docs/1.0/synvo-api/file-metadata)** - Extract rich information from files
3. **[Session History](/docs/1.0/synvo-api/session-history)** - Manage conversation history
4. **[Advanced Querying](/docs/1.0/synvo-api/query-retrieval)** - Streaming, web search, and more
